...
def main():
    ...
    if args.do_train:
        ...
        print("------------------epoch loss---------------------")
        print(f"Average loss for epoch was: {avg_train_loss} ")
        average_epo_loss_history.append(avg_train_loss)
        ...
        fig2 = plt.figure()
        plt.plot(average_epo_loss_history)
        fig2.savefig(f'{args.output_dir}/epochloss_{args.readmission_mode}_{args.date}.png', dpi=fig2.dpi)
