...
dataset['train'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, set = "train")[:1000]
dataset['validation'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, set = "valid")[:500]
dataset['test'] = MimicProcessor().get_examples(data_dir = mimic_data_dir, set = "test")[:500]
